...
window.LANG_EN = {
  ...
  "hero.sub": "Paste your (Teams) transcript or any other document, choose exactly which sections you want to include and how you want the output to look, and MeetingSum builds a professional AI prompt for you and can also structure the output for you if needed. No noise, just results.",
  ...
  "step2.analysis.custom.openDetail": "Click to view the full instruction",
  "step2.analysis.custom.detailTitle": "View custom instruction",
  "step2.analysis.custom.detailDesc": "Review the full instruction and choose whether to use it.",
  "step2.analysis.custom.detailCancel": "Cancel",
  "step2.analysis.custom.detailUse": "Use",
